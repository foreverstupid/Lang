...
namespace Lang.RpnItems
{
    ...
    /// </summary>
    public sealed class RpnGreater : RpnLogicalOperation
    {
        public RpnGreater(Token token, bool isReversed = false)
        ...
        protected override bool GetBoolResult(RpnConst left, RpnConst right)
            => left.ValueType switch
            {
                ...
                RpnConst.Type.String => IsGreater(left.GetString(), right.GetString()),
                var type =>
